...
class ScenarioEnum(str , Enum):
    ...
    ELEPHANTFLOW_LEGACY = "Test Elephant Flow alerts with basic data(7.6 device or older)"
    CORRELATION_CPU_LINA = "Push data and test correlation alerts for CPU_LINA_THRESHOLD_BREACH"
    CORRELATION_CPU_SNORT = "Push data and test correlation alerts for CPU_SNORT_THRESHOLD_BREACH"
