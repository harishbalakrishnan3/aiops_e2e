Feature: Capacity Analytics
  # This feature contains the sanity test for forecast insight generation of the snort CPU metric
  ...
  Scenario: Test forecast insight generation for Snort CPU metric
